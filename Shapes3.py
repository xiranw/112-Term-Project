...
def getHandCircle(self):
    ...
    for body in self.bodyDict:
        ...
        leftHand = bodyCircle(leftHandPos)
...
def generateBodyCircles(self):
    ...
    for body in self.bodyDict:
        ...
        head = bodyCircle(headPos)
        leftHand = bodyCircle(leftHandPos)
        rightHand = bodyCircle(rightHandPos)
        leftFoot = bodyCircle(leftFootPos)
        rightFoot = bodyCircle(rightFootPos)
